...
namespace WATS.BLL
{
    public class AppInfo
    {
        ...
        public Entities.InnerPages FEGetListMainLayout(string Email, ref WATS.Entities.InnerPages objPMInnerPages, ref WATS.Entities.InnerPages objGMInnerPages, ref int status)
        {
            ...
            List<WATS.Entities.Events> lstUpcommingEvents = new List<Entities.Events>();
            ...
            if (ds.Tables[6].Rows.Count == 1)
            {
                ...
                objMembers.IsLockedOut = (ds.Tables[6].Rows[0]["IsLockedOut"] != DBNull.Value ? Convert.ToBoolean(ds.Tables[6].Rows[0]["IsLockedOut"]) : false);
                objMembers.IsActivated = (ds.Tables[6].Rows[0]["IsActivated"] != DBNull.Value ? Convert.ToBoolean(ds.Tables[6].Rows[0]["IsActivated"]) : false);                
            ...
            objInnerPages.lstUpcommingEvents = lstUpcommingEvents;
