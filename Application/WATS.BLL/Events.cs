...
namespace WATS.BLL
{
    public class Events
    {
        ...
        public Int64 InsertCulturalEventUserInfo(Entities.CulturalUserInfo objEventUserInfo, ref Int64 EventUserInfoId, ref Int64 ChoreographerId, ref string backgroundimgurl, ref string AudioFile)
        {
            Int64 _status = 0;
            if (objEventUserInfo != null)
            {
        ...
        public Entities.Events FEGetEventById(Int64 EventId, string EventName, ref List<Entities.EventRegistrationTypes> lstEventRegistrationTypes, ref List<Entities.RegistrationCategories> lstEventRegistrationCategories, ref int status)
        {
            ...
            if (ds.Tables[0].Rows.Count == 1)
            {
                ...
                objEvent.MetaDescription = (ds.Tables[0].Rows[0]["MetaDescription"] != DBNull.Value ? ds.Tables[0].Rows[0]["MetaDescription"].ToString() : null);
                objEvent.UpdatedTime = Convert.ToDateTime(ds.Tables[0].Rows[0]["UpdatedTime"]);
                objEvent.IsVIP = (ds.Tables[0].Rows[0]["IsVIP"] != DBNull.Value ? Convert.ToBoolean(ds.Tables[0].Rows[0]["IsVIP"]) : false);
        ...
        public List<WATS.Entities.Events> GetEventsListByVariable(Int64 EventStatusId, string EventType, string StartDate, string EndDate, string Search, string Sort, int PageNo, int Items, ref int Total)
        {
            ...
            if (dt.Rows.Count != 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    objEvent.IsVIP = (dr["IsVIP"] != DBNull.Value ? Convert.ToBoolean(dr["IsVIP"]) : false);
        ...
        public Entities.EventUserInfo FEGetEventUserInfoFullDetailsById(Int64 EventUserInfoGetById, Int64 EventId, ref Entities.Events objEvent, ref List<Entities.EventRegistrationCounts> lstEventRegistrationCounts, ref List<Entities.EventsTickets> lstEventsTickets, ref int status)
        {
            DataSet ds = _Events.FEGetEventUserInfoFullDetailsById(EventUserInfoGetById, EventId, ref status);
            Entities.EventUserInfo objEventUserInfo = new Entities.EventUserInfo();
            ...
            if (ds.Tables[0].Rows.Count == 1)
            {
                ...
                objEventUserInfo.CoorFirstName = (ds.Tables[0].Rows[0]["CoorFirstName"] != DBNull.Value ? ds.Tables[0].Rows[0]["CoorFirstName"].ToString() : null);
                objEventUserInfo.CoorLastName = (ds.Tables[0].Rows[0]["CoorLastName"] != DBNull.Value ? ds.Tables[0].Rows[0]["CoorLastName"].ToString() : null);
                objEventUserInfo.CoorEmail = (ds.Tables[0].Rows[0]["CoorEmail"] != DBNull.Value ? ds.Tables[0].Rows[0]["CoorEmail"].ToString() : null);
                objEventUserInfo.CoorMobileNo = (ds.Tables[0].Rows[0]["CoorMobileNo"] != DBNull.Value ? ds.Tables[0].Rows[0]["CoorMobileNo"].ToString() : null);
                objEventUserInfo.CoorCity = (ds.Tables[0].Rows[0]["CoorCity"] != DBNull.Value ? ds.Tables[0].Rows[0]["CoorCity"].ToString() : null);
                objEventUserInfo.EventCommentId = (ds.Tables[0].Rows[0]["EventCommentId"] != DBNull.Value ? Convert.ToInt64(ds.Tables[0].Rows[0]["EventCommentId"].ToString()) : 0);
                objEventUserInfo.Status = (ds.Tables[0].Rows[0]["Status"] != DBNull.Value ? ds.Tables[0].Rows[0]["Status"].ToString() : null);
                objEventUserInfo.Comment = (ds.Tables[0].Rows[0]["Comment"] != DBNull.Value ? ds.Tables[0].Rows[0]["Comment"].ToString() : null);
            ...
            if (ds.Tables[2].Rows.Count == 1)
            {
                ...
                objEventUserInfo.objEventOrderDetails.EventOrderId = (ds.Tables[2].Rows[0]["EventOrderId"] != DBNull.Value ? Convert.ToInt64(ds.Tables[2].Rows[0]["EventOrderId"]) : 0);
            }
        ...
        public List<WATS.Entities.EventUserInfo> GetEventUserInfoListByVariable(Int64 EventId, string Type, string Search, string Sort, int PageNo, int Items, ref int Total)
        {
            ...
            if (dt.Rows.Count != 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    objEvent.Status = (dr["Status"] != DBNull.Value ? dr["Status"].ToString() : null);
                    objEvent.Comment = (dr["Comment"] != DBNull.Value ? dr["Comment"].ToString() : null);
        ...
        public Int64 InsertEventComments(Entities.EventComments objEvents)
        {
            Int64 _status = 0;
            if (objEvents != null)
            {
                _status = _Events.InsertEventComments(objEvents);
            }
            return _status;
        }
        ...
        public Int64 UpdateCulturalUserInfoStatus(Int64 EventUserInfoGetById)
        {
            Int64 _status = 0;
            _status = _Events.UpdateCulturalUserInfoStatus(EventUserInfoGetById);
            return _status;
        }

        public Int64 UpdateCulturalUserInfo(Entities.CulturalUserInfo objEventUserInfo)
        {
            Int64 _status = 0;
            if (objEventUserInfo != null)
            {
                _status = _Events.UpdateCulturalUserInfo(objEventUserInfo);
            }
            return _status;
        }

        public Entities.CulturalUserInfo GetCulturalUserInfoFullDetailsById(Int64 EventUserInfoGetById, Int64 EventId, ref Entities.Events objEvent, ref List<Entities.EventRegistrationCounts> lstEventRegistrationCounts, ref List<Entities.EventsTickets> lstEventsTickets, ref int status)
        {
            DataSet ds = _Events.GetCulturalUserInfoFullDetailsById(EventUserInfoGetById, EventId, ref status);
            Entities.CulturalUserInfo objEventUserInfo = new Entities.CulturalUserInfo();
            List<Entities.CulturalParticipants> lstEventParticipants = new List<Entities.CulturalParticipants>();
        ...
        public Int64 InsertCulturalParticipant(Entities.CulturalParticipants objEventParticipants)
        {
            Int64 _status = 0;
            if (objEventParticipants != null)
            {
                _status = _Events.InsertCulturalParticipant(objEventParticipants);
            }
            return _status;
        }

        public Int64 UpdateCulturalParticipant(Entities.CulturalParticipants objEventParticipants)
        {
            Int64 _status = 0;
            if (objEventParticipants != null)
            {
                _status = _Events.UpdateCulturalParticipant(objEventParticipants);
            }
            return _status;
        }
        ...
        {
            Int64 _status = 0;
            _status = _Events.DeleteCulturalParticipantsById(CulturalParticipantId);
            return _status;
        }

        public Entities.CulturalUserInfo CulturalUserInfoGetById(Int64 EventUserInfoGetById, ref int status)
        {
            DataTable dt = _Events.CulturalUserInfoGetById(EventUserInfoGetById, ref status);
            Entities.CulturalUserInfo objEventUserInfo = new Entities.CulturalUserInfo();
        ...
        {
            Int64 _status = 0;
            _status = _Events.DeleteCulturalUserInfoById(EventUserInfoId);
            return _status;
        }
        #endregion
        ...
        {
            Int64 _status = 0;
            _status = _Events.FEGetBatchCount(EventId, ref Batch1, ref Batch2, ref Batch3, ref Batch4, ref Batch5);
            return _status;
        }
        ...
        {
            Int64 _status = 0;
            _status = _Events.FERegCountForEventReg(MemberId, ref RegCount, EventId);
            return _status;
        }

        public List<WATS.Entities.EventRegistrationCounts> EventTicketsCount(Int64 EventId, ref int Status, ref int Batch1, ref int Batch2, ref int Batch3, ref int Batch4, ref int Batch5, ref int Others)
        {
            List<WATS.Entities.EventRegistrationCounts> lstEventRegCount = new List<Entities.EventRegistrationCounts>();
            DataTable dt = _Events.EventTicketsCount(EventId, ref Status, ref Batch1, ref Batch2, ref Batch3, ref Batch4, ref Batch5, ref Others);

            if (dt.Rows.Count != 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    WATS.Entities.EventRegistrationCounts objRegCount = new WATS.Entities.EventRegistrationCounts();

                    objRegCount.EventRegistrationTypeId = Convert.ToInt64(dr["EventRegistrationTypeId"]);
                    objRegCount.Count = (dr["Count"] != DBNull.Value ? Convert.ToInt32(dr["Count"]) : 0);
                    objRegCount.RegistrationTitle = (dr["Type"] != DBNull.Value ? dr["Type"].ToString() : null);
                    objRegCount.EventId = (dr["EventId"] != DBNull.Value ? Convert.ToInt64(dr["EventId"]) : 0);

                    lstEventRegCount.Add(objRegCount);
                }

            }
            return lstEventRegCount;
        }
