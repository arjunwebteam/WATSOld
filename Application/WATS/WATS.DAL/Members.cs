...
namespace WATS.DAL
{
    public class Members
    {
        ...
        public DataTable GetMembersListByVariable(string Search, Int64 MembershipTypeId, Int64 PaymentStatusId, string StartDate, string EndDate, string ExpiryDate, string IsVolunteer, string Sort, int PageNo, int Items, ref int Total)
        {
            DataTable dt = null;
            try
            {
