...
{
    [Models.SessionClass.PermitAccess(Roles = "SuperAdmin,Events,WebMaster,Cultural,Treasurer")]
    ...
    public class EventsController : Controller
    {
        ...
        [HttpGet]
        public ActionResult EventsList(Int64 EventStatusId = 0, string EventType = "upcoming", string StartDate = "", string EndDate = "", string search = "", string SortColumn = "StartDate", string SortOrder = "DESC", int PageNo = 1, int PageItems = 10, string Type = "")
        {
