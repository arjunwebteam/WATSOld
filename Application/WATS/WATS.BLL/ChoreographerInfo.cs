   ...
   public class ChoreographerInfo
    { 
        ...
        public Entities.ChoreographerInfo GetChoreographerFullDetailsByEmail(string Email, ref int status)
        {
            ...
            objChoreographerInfo.lstEventParticipants = lstEventParticipants;
        ...
        public List<WATS.Entities.EventParticipants> GetEventParticipantsGetlistbyId(Int64 ChoreographerId, ref int Total)
        {
