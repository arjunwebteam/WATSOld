...
offCanvasNav({
		...
		nav_next_btn: '<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>'
});
...
// tabbed content TAB 1
  ...
  /* if in tab mode */
	...
	$(".tab_drawer_heading2").click(function() {
	  ...
	  $("ul.tabs2 li a").removeClass("active");
	  $("ul.tabs2 li a[rel^='"+d_activeTab+"']").addClass("active");
    });
	...
	/* Extra class "tab_last" 
	   to add border to right side
	   of last tab */
	$('ul.tabs2 li a').last().addClass("tab_last");
	...
	function viewprofile() {
	    $('#editprofilebtn').show('slow');
	    $('#editprofilebtn1').show('slow');
	    $('#editdiv').hide('slow');
	    $('#viewdiv').show('slow');
	}

	function editbtnshow2() {
	    $('#viewdiv2').show();
	    $('#editdiv2').hide();
	    $('#editprofilebtn2').show('slow');
	}
	function editbtnhide2() {
	    $('#editprofilebtn2').hide('slow');
	    $('#editprofilebtn3').hide('slow');
	}
