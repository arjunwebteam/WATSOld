...
<script runat="server">
            ...
            public override void SetConfig()
            {
                ...
                BaseUrl = System.Configuration.ConfigurationManager.AppSettings["usersiteurl"] + "Content/uploads/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath(System.Configuration.ConfigurationManager.AppSettings["usersiteurl"] + "Content/uploads/");
