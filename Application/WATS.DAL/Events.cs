...
namespace WATS.DAL
{
    public class Events
    {
        ...
        public Int64 FEInsertEventUserInfo(WATS.Entities.EventUserInfo objEventUserInfo, ref Int64 EventUserInfoId)
        {
            ...
            try
            {
                _sqlP = new[]
                    ...
                    new SqlParameter("@QStatus",0),
                    new SqlParameter("@XMLRegistrationsCounts",(objEventUserInfo.XMLRegistrationsCounts==null?(object)DBNull.Value:objEventUserInfo.XMLRegistrationsCounts)),
                    new SqlParameter("@AreYouEmployee",(objEventUserInfo.AreYouEmployee==null?(object)DBNull.Value:objEventUserInfo.AreYouEmployee)),
                    new SqlParameter("@AcceptTerms",(objEventUserInfo.AcceptTerms==null?(object)DBNull.Value:objEventUserInfo.AcceptTerms)),
                    new SqlParameter("@IsVolunteer",(objEventUserInfo.IsVolunteer==null?(object)DBNull.Value:objEventUserInfo.IsVolunteer))
                    };
        ...
        public Int64 InsertCulturalEventUserInfo(WATS.Entities.CulturalUserInfo objEventUserInfo, ref Int64 EventUserInfoId, ref Int64 ChoreographerId, ref string backgroundimgurl, ref string AudioFile)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                    ...
                    new SqlParameter("@CoorFirstName",(objEventUserInfo.CoorFirstName==null?(object)DBNull.Value:objEventUserInfo.CoorFirstName)),
                    new SqlParameter("@CoorLastName",(objEventUserInfo.CoorLastName==null?(object)DBNull.Value:objEventUserInfo.CoorLastName)),
                    new SqlParameter("@CoorEmail",(objEventUserInfo.CoorEmail==null?(object)DBNull.Value:objEventUserInfo.CoorEmail)),
                    new SqlParameter("@CoorMobileNo",(objEventUserInfo.CoorMobileNo==null?(object)DBNull.Value:objEventUserInfo.CoorMobileNo)),
                    new SqlParameter("@CoorCity",(objEventUserInfo.CoorCity==null?(object)DBNull.Value:objEventUserInfo.CoorCity)),
                    new SqlParameter("@DinnerBatch",(objEventUserInfo.DinnerBatch==null?(object)DBNull.Value:objEventUserInfo.DinnerBatch))
                    };
        ...
        public DataSet FEGetEventUserInfoFullDetailsById(Int64 EventUserInfoId, Int64 EventId, ref int Status)
        {
            DataSet ds = null;
            try
            {
        ...
        public DataTable TicketInfoExport(Int64 EventId, string Type, string Search, string Sort)
        {
            DataTable dt = null;
            Int32 Total = 0;
            try
            {
                ...
                _sqlP[3].Direction = System.Data.ParameterDirection.Output;
                dt = _dbAccess.GetDataTable("TicketInfoExport", ref _sqlP);
                Total = Convert.ToInt32(_sqlP[3].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 UpdateCulturalUserInfoStatus(Int64 EventUserInfoId)
        {
            Int64 _status = 0;
            try
            {
                ...
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalUserInfoUpdateStatus", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[1].Value);
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetCulturalUserInfoFullDetailsById(Int64 EventUserInfoId, Int64 EventId, ref int Status)
        {
            DataSet ds = null;
            try
            {
                ...
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                ds = _dbAccess.GetDataSet("CulturalUserInfoFullDetailsGetById", ref _sqlP);
                Status = Convert.ToInt32(_sqlP[1].Value);
            }
            catch (Exception ex)
            {
        ...
        #region CulturalParticipants

        public DataTable CulturalUserInfoGetById(Int64 EventUserInfoId, ref int Status)
        {
            DataTable dt = null;
            try
            {
                ...
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                dt = _dbAccess.GetDataTable("CulturalUserInfoGetById", ref _sqlP);
                Status = Convert.ToInt32(_sqlP[1].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 UpdateCulturalUserInfo(WATS.Entities.CulturalUserInfo objEventUserInfo)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                    ...
                    new SqlParameter("@UpdatedBy",objEventUserInfo.UpdatedBy),
                    new SqlParameter("@UpdatedTime",DateTime.UtcNow),
                    new SqlParameter("@CulturalOrderId",objEventUserInfo.CulturalOrderId),
                    new SqlParameter("@EventId",objEventUserInfo.EventId),
                    new SqlParameter("@PaymentStatusId",(objEventUserInfo.PaymentStatusId==0?(object)DBNull.Value:objEventUserInfo.PaymentStatusId)),
                    new SqlParameter("@PaymentDate",(objEventUserInfo.PaymentDate==DateTime.MinValue?(object)DBNull.Value:objEventUserInfo.PaymentDate)),
                    new SqlParameter("@PaymentMethodId",(objEventUserInfo.PaymentMethodId==0?(object)DBNull.Value:objEventUserInfo.PaymentMethodId)),
                ...
                _sqlP[35].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalUserInfoUpdate", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[35].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 InsertCulturalParticipant(WATS.Entities.CulturalParticipants objEventParticipant)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                    {
                    new SqlParameter("@CulturalParticipantId",objEventParticipant.CulturalParticipantId),
                    new SqlParameter("@EventId",objEventParticipant.EventId),
                    new SqlParameter("@EventUserInfoId",objEventParticipant.EventUserInfoId ),
                    new SqlParameter("@FirstName",objEventParticipant.FirstName),
                    new SqlParameter("@LastName",objEventParticipant.LastName),
                ...
                _sqlP[11].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalParticipantsInsert", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[11].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 UpdateCulturalParticipant(WATS.Entities.CulturalParticipants objEventParticipant)
        {
            Int64 _status = 0;
            try
            {
                ...
                _sqlP[11].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalParticipantsUpdate", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[11].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 DeleteCulturalParticipantsById(Int64 CulturalParticipantId)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                {
                    new SqlParameter("@CulturalParticipantId",CulturalParticipantId),
                    new SqlParameter("@QStatus",0)
                };
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalParticipantsDelete", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[1].Value);
            }
            catch (Exception ex)
            {
        ...
        public Int64 DeleteCulturalUserInfoById(Int64 EventUserInfoId)
        {
            Int64 _status = 0;
            try
            {
                ...
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("CulturalUserInfoDelete", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[1].Value);
            }
            catch (Exception ex)
            {
        ...
        #region EventComments

        public Int64 InsertEventComments(WATS.Entities.EventComments objEventCom)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                    {
                    new SqlParameter("@EventCommentId",objEventCom.EventCommentId),
                    new SqlParameter("@EventUserInfoId",objEventCom.EventUserInfoId ),                    
                    new SqlParameter("@Status",(objEventCom.Status==null?(object)DBNull.Value:objEventCom.Status)),
                    new SqlParameter("@Comment",(objEventCom.Comment==null?(object)DBNull.Value:objEventCom.Comment)),
                    new SqlParameter("@InsertedBy",(objEventCom.InsertedBy==null?(object)DBNull.Value:objEventCom.InsertedBy)),                    
                    new SqlParameter("@QStatus",0),
                    new SqlParameter("@EmployeeRefUrl",(objEventCom.EmployeeRefUrl==null?(object)DBNull.Value:objEventCom.EmployeeRefUrl)),
                    new SqlParameter("@EmployeeCode",(objEventCom.EmployeeCode==null?(object)DBNull.Value:objEventCom.EmployeeCode)),
                ...
                _sqlP[5].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("EventCommentsInsert", ref _sqlP);
        ...
        public Int64 FEGetBatchCount(Int64 EventId, ref int Batch1, ref int Batch2, ref int Batch3, ref int Batch4, ref int Batch5)
        {
            Int64 _status = 0;
            try
            {
                ...
                {
                    new SqlParameter("@EventId",EventId),
                    new SqlParameter("@Batch1",Batch1),
                    new SqlParameter("@Batch2",Batch2),
                    new SqlParameter("@Batch3",Batch3),
                    new SqlParameter("@Batch4",Batch4),
                    new SqlParameter("@Batch5",Batch5),
                    new SqlParameter("@QStatus",0)
                };
                _sqlP[1].Direction = _sqlP[2].Direction = _sqlP[3].Direction = _sqlP[4].Direction = _sqlP[5].Direction = System.Data.ParameterDirection.Output;
                _sqlP[6].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("FEGetBatchCount", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[6].Value);
                Batch1 = Convert.ToInt32(_sqlP[1].Value);
                Batch2 = Convert.ToInt32(_sqlP[2].Value);
                Batch3 = Convert.ToInt32(_sqlP[3].Value);
                Batch4 = Convert.ToInt32(_sqlP[4].Value);
                Batch5 = Convert.ToInt32(_sqlP[5].Value);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public Int64 FERegCountForEventReg(Int64 MemberId, ref int RegCount, Int64 EventId)
        {
            Int64 _status = 0;
            try
            {
                _sqlP = new[]
                {
                    ...
                    new SqlParameter("@QStatus",0),
                    new SqlParameter("@RegCount",RegCount),
                    new SqlParameter("@EventId",EventId)
                };
                _sqlP[2].Direction = System.Data.ParameterDirection.Output;
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                _dbAccess.SP_ExecuteScalar("FERegCountForEventReg", ref _sqlP);
                _status = Convert.ToInt64(_sqlP[1].Value);
                RegCount = Convert.ToInt32(_sqlP[2].Value);
        ...
        public DataTable EventTicketsCount(Int64 EventId, ref int Status, ref int Batch1, ref int Batch2, ref int Batch3, ref int Batch4, ref int Batch5, ref int Others)
        {
            DataTable dt = null;
            try
            {
                ...
                _sqlP[2].Direction = _sqlP[3].Direction = _sqlP[4].Direction = _sqlP[5].Direction = _sqlP[6].Direction = _sqlP[7].Direction = System.Data.ParameterDirection.Output;
                _sqlP[1].Direction = System.Data.ParameterDirection.Output;
                dt = _dbAccess.GetDataTable("EventsTicketCounts", ref _sqlP);
                Status = Convert.ToInt32(_sqlP[1].Value);
                //Batch1 = Convert.ToInt32(_sqlP[2].Value);
                //Batch2 = Convert.ToInt32(_sqlP[3].Value);
                //Batch3 = Convert.ToInt32(_sqlP[4].Value);
                //Batch4 = Convert.ToInt32(_sqlP[5].Value);
                //Batch5 = Convert.ToInt32(_sqlP[6].Value);
                //Others = Convert.ToInt32(_sqlP[7].Value);
            }
            catch (Exception ex)
            {
                throw ex;
